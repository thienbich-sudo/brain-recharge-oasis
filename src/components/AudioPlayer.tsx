...
const playlist = [
  ...
  { id: 't5', title: 'L.V. Beethoven - Moonlight Sonata', desc: { vi: 'Trạng thái tuôn trào (Piano)', en: 'Abstract Flow State', zh: '抽象心流状态' }, url: '/audio/moonlight.mp3', color: '#60a5fa' },
  { id: 't6', title: 'J.S. Bach - Prelude No. 1', desc: { vi: 'Thiền định & Logic', en: 'Meditation & Logic', zh: '静心与逻辑' }, url: '/audio/bach.mp3', color: '#facc15' },
  { id: 't7', title: 'F. Chopin - Nocturne Op.9', desc: { vi: 'Đồng bộ hai bán cầu não', en: 'Brain Sync & Clarity', zh: '左右脑同步' }, url: '/audio/chopin.mp3', color: '#fb923c' },
];
